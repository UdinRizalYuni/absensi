        ...
        <div class="col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><marquee scrolldelay="50" direction="left"  behavior="slide">Halaman Administrator Sistem Informasi Absensi Pegawai Sekolah Menengah Atas (SMA)</marquee></h3>
                </div>
