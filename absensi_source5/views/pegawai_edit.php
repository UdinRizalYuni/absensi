        ...
        <div class="col-xs-12">  
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Update Pegawai</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
						<div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="varchar" name="nik" value="<?=$data['nik']?>"class="form-control" id="inputEmail3" placeholder="Inputkan NIK Pegawai ">
                            </div>
							</div>
							<div class="form-group">
                            <label for="nama" class="col-sm-2 control-label">Nama</label>
                            <div class="col-sm-9">
                                <input type="varchar" name="nama" value="<?=$data['nama']?>"class="form-control" id="inputEmail3" placeholder="Inputkan Nama Pegawai ">
                            </div>
							</div>
							<div class="form-group">
                            <label for="pendidikan" class="col-sm-2 control-label">Pendidikan</label>
                            <div class="col-sm-9">
                                <input type="varchar" name="pendidikan" value="<?=$data['pendidikan']?>"class="form-control" id="inputEmail3" placeholder="Inputkan Pendidikan Pegawai ">
                            </div>
							</div>
					...
					<!--Form Untuk memilih Jenis Kelamin-->			
                            ...
                            <div class="col-sm-9">
                                <input type="varchar" name="alamat" value="<?=$data['alamat']?>"class="form-control" id="inputEmail3" placeholder="Inputkan Alamat Pegawai" required>
                            </div>
                        </div>
