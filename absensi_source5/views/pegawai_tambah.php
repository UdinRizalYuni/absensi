            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="varchar" name="pendidikan" class="form-control" id="inputEmail3" placeholder="Inputkan Pendidikan Pegawai" required>
                            </div>
                        </div>
						<div class="form-group">
					...
					<!--Form Untuk memilih Jenis Kelamin-->			
                            ...
                            <div class="col-sm-9">
                                <input type="varchar" name="alamat" class="form-control" id="inputEmail3" placeholder="Inputkan Alamat Pegawai" required>
                            </div>
                        </div>
